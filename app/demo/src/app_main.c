...
hi_void app_main(hi_void)
{
...
#endif
#ifdef CONFIG_HISTREAMING_SUPPORT1
    ...
    // gpio5_switch_init();            //按键初始化
    // gpio5_interrupt_monitor();      //按键中断监听task
    // printf("gpio5_interrupt_monitor\n");
    // app_c08i_nfc_i2c_demo_task();   //NFC碰一碰task
    // printf("app_c08i_nfc_i2c_demo_task\n");
    // app_oled_i2c_demo_task();       //OLED显示屏task
